...
//,assetName,purchaseDate,Amount
	...
	$sql="SELECT * from asset WHERE (purchasedBy) LIKE '%$result%'  or assetName LIKE '%$result%' or assetId LIKE '%$result%' AND purchasedBy='Head Of Community Development Department'";
