                        ...
                        <div class="panel-body">
                            ...
                            <!--figure in the class reduces/increase the actual form/inputs-->
                                <div class="col-md-9">
                                    ...
                                    <form role="form" action="Community DevelopmentsubmitAsset.php" method="post" enctype="multipart/form-data">
                                        <div class="form-group input-group">
                                            <span class="input-group-addon"></span>';
											
											
$row=mysql_query('SELECT assetId from asset where purchasedBy="Head Of Community Development Department" order by assetId desc LIMIT 1',$conn);
	...
	while($shwduty = mysql_fetch_array($row))
	   {
				...
				$ans = 	++$id;				
                              ...
                              echo '<input type="text" class="form-control" placeholder="'.$ans.'" name="AssetId" value="'.$ans.'" readonly  />
                                        ...
                                        <div class="form-group input-group">
                                            <span class="input-group-addon"></span>
                                            <input type="text" class="form-control" placeholder="Head Of Community Development Department" name="PurchasedBy" value="Head Of Community Development Department" readonly/>
                                        </div>
