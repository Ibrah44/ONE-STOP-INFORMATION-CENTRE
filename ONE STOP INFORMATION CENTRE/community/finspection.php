...
<body>
  ...
  <div style="color: white; padding: 15px 50px 5px 50px;/*float: right;*/ font-size: 16px;"> <font size="5" face="times new romans"> WAKISO ONE STOP SHOPING CENTER</font> &nbsp; <a style="float: right" href="../logout" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        </nav>   
           <!-- /. NAV TOP  -->
           <nav class="navbar-default navbar-side" role="navigation">
              ...
              <li>
                        <a class=""  href="communityindex.php"><img src="pics/home.png" width="50" height="50px"> Home</a>                    </li>
              <li>
	...
	$row=mysql_query('SELECT inspectionId FROM inspect where doneBy="Head Of Community Development Department" order by inspectionId desc LIMIT 1',$conn);
	...
	while($shwduty = mysql_fetch_array($row))
	   {
				...
				$ans = 	++$id;				
                              ...
                              <input type="text" class="form-control" placeholder="Activity Name" name="activityname" required/>
                                          ...
                                          <div class="form-group input-group">
                                            <span class="input-group-addon"></span>
      <input type="text" class="form-control" placeholder="Head Of Community Development Department" name="inspectedby" value="Head Of Community Development Department" readonly/>
                                        </div>
