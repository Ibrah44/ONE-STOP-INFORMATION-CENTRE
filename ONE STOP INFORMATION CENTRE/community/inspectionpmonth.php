...
<head>
    ...
    <title>View Monthly Inspections</title>
	<!-- BOOTSTRAP STYLES-->
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                 ...
                 <!-- /. ROW  -->';
				 echo '<table border="0" align="center" width="650PX"> <tr> <td><a href="viewinspection.php">view all inspections carried out</a> &nbsp;&nbsp;&nbsp;&nbsp;</td>  <td><a href="inspectionpyear.php">view inspections carried out in the previous year</a>&nbsp;&nbsp;&nbsp;&nbsp;</td> </tr> </table>';	
                echo '  <hr />
                <div class="row">
...
echo	'</tr>';
	$get=mysql_query("select * from inspect where inspectionDate like '%$si%' AND doneBy='Head Of Community Development Department' order by inspectionId desc ",$conn);
	...
	echo '&nbsp;&nbsp;&nbsp';     
	 echo '<a href="printinspectionm.php"><input type="button" value="Print" class="btn btn-primary "></a>';     
