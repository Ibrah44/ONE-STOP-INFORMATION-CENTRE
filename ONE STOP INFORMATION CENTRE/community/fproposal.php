...
<body>
  ...
  <div style="color: white; padding: 15px 50px 5px 50px;/*float: right;*/ font-size: 16px;"><font size="5" face="times new romans"> WAKISO ONE STOP SHOPING CENTER</font> &nbsp; <a style="float: right" href="../logout.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
	...
	$row=mysql_query('SELECT projectId from project where submitedBy="Head Of Community Development Department" order by projectId desc LIMIT 1',$conn);
	...
	while($shwduty = mysql_fetch_array($row))
	   {
				...
				$ans = 	++$id;				
                              ...
                              echo '<input type="text" class="form-control" placeholder="'.$ans.'" name="ProjectId" value="'.$ans.'" readonly  />
                                        ...
                                        <div class="form-group input-group">
                                            <span class="input-group-addon"></span>
                                 <input type="text" class="form-control" placeholder="Head Of Community Development Department"  name="SubmittedBy" value="Head Of Community Development Department" readonly/>
                                        </div>
                                        <div class="form-group input-group">
