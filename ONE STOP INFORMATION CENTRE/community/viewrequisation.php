...
echo	'</tr>';
	$row=mysql_query("select requestId,itemName,purpose,quantity,status,requestDate,downloadApproval from request where requestedBy='Head Of Community Development Department'",$conn);
