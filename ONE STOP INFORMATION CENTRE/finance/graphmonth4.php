...
include('phpgraphlib.php');
                         ...
                         $data = mysql_query('SELECT * FROM duty where assignedTo="Head Of Finance Department" AND deadline like "2015-04%" ');
                         $num_ro = mysql_num_rows($data);

                   // echo $num_ro."total"."<br/>";
					 
                     $result2n = mysql_query('SELECT * FROM duty where assignedTo="Head Of Finance Department" AND status="pending" AND deadline like "2015-04%" ');
						...
						// echo $num_rows."pending"."<br/>";
						 //% of pending
							 ...
							 // echo $try2."<br/>";
							    $result3 = mysql_query('SELECT * FROM duty where assignedTo="Head Of Finance Department" AND status="Accomplished" AND deadline like "2015-04%"');
