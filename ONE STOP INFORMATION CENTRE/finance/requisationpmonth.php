...
echo	'</tr>';
	$row=mysql_query("select requestId,itemName,purpose,quantity,status,requestDate,downloadApproval from request where requestDate like '%$si%' AND requestedBy='Head Of Finance Department' order by requestId desc",$conn);
