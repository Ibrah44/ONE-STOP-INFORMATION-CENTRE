...
echo	'</tr>';
	$row=mysql_query('select dutyId,dutyName,dutyDetails,status,deadline,doneDate from duty where status ="Accomplished" AND assignedTo="Head Of Finance Department" order by dutyId desc');
