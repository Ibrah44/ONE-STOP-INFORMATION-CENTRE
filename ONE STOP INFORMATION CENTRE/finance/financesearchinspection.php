           ...
           <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse ">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a  href="requisation.html"><img src="pics/requestnew.png" width="50" height="50px">Requistions</a>
						</li>
							<li>
...
//,assetName,purchaseDate,Amount
	...
	$sql="SELECT * from inspect WHERE (inspectionId) LIKE '%$result%'  or activityName LIKE '%$result%' AND doneBy='Head Of Finance Department'";
