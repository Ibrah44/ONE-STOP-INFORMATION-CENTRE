            ...
            <div class="sidebar-collapse ">
				...
				<li class="text-center">
					...
					<a class=""><i class="fa  fa-3x"></i> <img src="pics/service.png" width="200" height="50px"></a>
                      ...
                      <li>
                        <a href="departmentindex.php"> <img src="pics/home.png" width="50" height="50px"></i>Home</a>
                    </li>
                        <li>
                        <a href="inspection.html"> <img src="pics/inspection.jpg" width="50" height="50px"> Inspect Activities</a>
                    </li>
                     <li>
                     ...
                     <li>
                        <a  href="requisation.html"><img src="pics/requestnew.png" width="50" height="50px"> Requisations</a>
                    </li>
                    <li>
                        <a  href="scheduletask.html"><img src="pics/schedul.png" width="50" height="50px">Schedule Task</a>
                        </li>
                        <li>
                        <a  href="proposal.html"><img src="pics/project.jpg" width="50" height="50px"> Propose Project</a>
                    </li>				
                </ul>
            </div>
        </nav>   <!-- /. NAV SIDE  -->
...
//,assetName,purchaseDate,Amount
	...
	$sql="SELECT * from asset WHERE (purchasedBy) LIKE '%$result%'  or assetName LIKE '%$result%' or assetId LIKE '%$result%' AND purchasedBy='Head Of Finance Department'";
	...
	echo '</table> &nbsp;&nbsp;&nbsp;&nbsp;			
			<center><a href="viewdepartmentasset.php" class="btn btn-primary">Back</a> </center> ';
