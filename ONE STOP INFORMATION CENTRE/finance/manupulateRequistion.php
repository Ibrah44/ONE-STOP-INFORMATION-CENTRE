...
echo '
 <div id="wrapper">
  ...
  <div style="color: white; padding: 15px 50px 5px 50px;/*float: right;*/ font-size: 16px; margin-left: 250px;">  WAKISO ONE STOP INFORMATION CENTRE &nbsp; <a style="float: right" href="login.html" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        </nav>   
           <!-- /. NAV TOP  -->
           <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse ">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a><i class=""></i><img src="assets/img/1.png">SERVICES</a>
                    </li>


                    <li>
                        <a class=""  href="caoindex.php"></i><font color="blue"> Home</font></a>
                    </li>
                     <li>
                        <a  href="allocateDuty.html"><i class=""></i><img src="assets/img/1.png" > Assign Duties</a>
                    </li>
                    ...
                    <li>
                        <a  href=" manipulateProject.php"><i class="fa fa-dashboard fa-3x"></i>Submitted Projects</a>
                </ul>
            </div>
        </nav>  
        <!-- /. NAV SIDE  -->
...
echo	'<tr>
          <td><b><i>Request ID</i></b></td>
         <td><b><i>Item Name</i></b></td>
		 
         <td><b><i>Quantity</i></b></td>
		 <td><b><i>Request Date</i></b></td>
...
echo	'</tr>';
	$getrequests=mysql_query('select * from request',$conn);
	
	
	while($shwrequests = mysql_fetch_array($getrequests))
	   {
	...
	echo ' 
	  ...
	  <td><table align=" " cellspacing="4"><tr> <td>
	   <a  href=" "><input type="button" value="Edit" ></a></td> <td>&nbsp;&nbsp;&nbsp;</td> <td> <a  href=""><input type="button" value="Delete" ></a></td>  </tr></table></td>
	...
	echo '<center>';
    echo '<a href="townAssets.html "><input type="button" value="Previous" class="btn btn-primary "></a>';
	echo '&nbsp;&nbsp;&nbsp';        
