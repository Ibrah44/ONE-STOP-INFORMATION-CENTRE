...
<body>
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="departmentindex.php">WISCO</a>
            </div>
  <div style="color: white; padding: 15px 50px 5px 50px;/*float: right;*/ font-size: 16px;"><font size="5" face="times new romans"> WAKISO ONE STOP INFORMATION CENTRE</font> &nbsp; <a style="float: right" href="../logout.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
	...
	$row=mysqli_query($conn,'SELECT taskId FROM task where taskScheduler="Head Of Finance Department" order by taskId desc LIMIT 1');
				...
				$ans = 	++$id;				
                              ...
                              echo '<input type="text" class="form-control" placeholder="'.$ans.'" name="TaskId" value="'.$ans.'" readonly />
                                       ...
                                       echo ' <div class="form-group input-group">
                                        ...
                                        <div class="form-group input-group">
                                            <span class="input-group-addon"></span>
                         <input type="text" class="form-control" placeholder="Head Of Finance Department" name="TaskSchuler"  value="Head Of Finance Department" readonly/>
                                        </div>
                                        <div class="form-group input-group">
