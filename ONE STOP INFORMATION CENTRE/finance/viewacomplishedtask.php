...
echo	'</tr>';
	...
	$row=mysql_query('select taskId,taskName,taskDetails,taskStatus,dateOfExecution from task where taskStatus ="Acomplished" AND taskScheduler="Head Of Finance Department" order by taskId desc');
