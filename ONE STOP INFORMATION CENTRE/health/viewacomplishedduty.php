...
<head>
    ...
    <title>Accomplished Duties</title>
	<!-- BOOTSTRAP STYLES-->
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                 ...
                 <!-- /. ROW  -->';
				 echo '<table border="0" align="center" width="auto"> <tr> <td><a href="viewduty.php">view all available duties</a> &nbsp;&nbsp;&nbsp;&nbsp;</td>  <td><a href="viewpendingduty.php">view pending duties</a>&nbsp;&nbsp;&nbsp;&nbsp;</td>  <td><a href="performanceanalysis.php">performance analysis</a>&nbsp;&nbsp;&nbsp;&nbsp;</td> </tr> </table>';	
...
echo	'</tr>';
	$row=mysql_query('select dutyId,dutyName,dutyDetails,status,deadline,doneDate from duty where status ="Accomplished" AND assignedTo="Head Of Health Department" order by dutyId desc');
