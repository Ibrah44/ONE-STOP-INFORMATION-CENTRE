...
echo	'<tr>
		 ...
		 $row=mysql_query("SELECT COUNT(dutyId) AS Acomplished FROM duty WHERE deadline like '$si%' AND status='Accomplished' AND assignedTo='Head Of Health Department' ");
	...
	echo '<td>'.$shwduty["Acomplished"].'</td>';
        ...
        echo '<tr> <td>Pending Duties</td>';
		   ...
		   $row=mysql_query("SELECT COUNT(dutyId) AS pending FROM duty WHERE deadline like '$si%' AND status='pending' AND assignedTo='Head Of Health Department'");
		 while($shwduty = mysql_fetch_array($row))
	   {
	...
	echo '<td>'.$shwduty["pending"].'</td>';
	  ...
	  $row=mysql_query("SELECT COUNT(dutyId) AS duti FROM duty WHERE deadline like '%$si%' AND assignedTo='Head Of Health Department'");
		 while($shwduty = mysql_fetch_array($row))
	   {
...
echo	'<tr>
		 ...
		 $row=mysql_query("SELECT COUNT(dutyId) AS Acomplished FROM duty WHERE deadline like '%$di%' AND status='Accomplished' AND assignedTo='Head Of Health Department'");
		 while($shwduty = mysql_fetch_array($row))
	   {
	...
	echo '<td>'.$shwduty["Acomplished"].'</td>';
        ...
        echo '<tr> <td>Pending Duties</td>';
		   ...
		   $row=mysql_query("SELECT COUNT(dutyId) AS pending FROM duty WHERE deadline like '%$di%' AND status='pending' AND assignedTo='Head Of Health Department'");
		 while($shwduty = mysql_fetch_array($row))
	   {
	...
	echo '<td>'.$shwduty["pending"].'</td>';
       ...
       echo ' <tr> <td>Total Number Of Duties</td>';
	  $row=mysql_query("SELECT COUNT(dutyId) AS duti FROM duty WHERE deadline like '%$di%' AND assignedTo='Head Of Health Department'");
		 while($shwduty = mysql_fetch_array($row))
	   {
