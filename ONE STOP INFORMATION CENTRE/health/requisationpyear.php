...
<head>
    ...
    <title>View Annual Requisations</title>
	<!-- BOOTSTRAP STYLES-->
...
echo	'</tr>';
	$row=mysql_query("select requestId,itemName,purpose,quantity,status,requestDate,downloadApproval from request where requestDate like '%$di%' AND requestedBy='Head Of Health Department' order by requestId desc",$conn);
