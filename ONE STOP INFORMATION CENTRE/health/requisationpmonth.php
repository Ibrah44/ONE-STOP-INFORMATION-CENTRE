...
<head>
    ...
    <title>View Monthly Requisations</title>
	<!-- BOOTSTRAP STYLES-->
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                 ...
                 <!-- /. ROW  -->';
				 echo '<table border="0" align="center" width="auto"> <tr> <td><a href="viewrequisation.php">view all requisations made</a> &nbsp;&nbsp;&nbsp;&nbsp;</td>  <td><a href="requisationpyear.php">view requisations made in the previous year</a>&nbsp;&nbsp;&nbsp;&nbsp;</td> <td><form method="POST" action="financesearchrequisation.php">
												   &nbsp;&nbsp;&nbsp;&nbsp;
...
echo	'</tr>';
	$row=mysql_query("select requestId,itemName,purpose,quantity,status,requestDate,downloadApproval from request where requestDate like '%$si%' AND requestedBy='Head Of Health Department' order by requestId desc",$conn);
	...
	echo '</table>
			&nbsp;&nbsp;&nbsp;&nbsp;			
			<center><a href="viewrequisation.php" class="btn btn-primary">Back</a> </center> 			
