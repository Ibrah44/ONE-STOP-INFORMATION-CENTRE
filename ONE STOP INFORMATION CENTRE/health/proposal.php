...
$SubmittedBy= 'Head Of Health Department';
...
$passq = mysqli_query("insert into project (projectId,projectName,projectDetails,dateOfSubmission,submitedBy,document,status)
