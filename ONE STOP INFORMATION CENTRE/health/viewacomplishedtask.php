...
echo	'</tr>';
	...
	$row=mysql_query('select taskId,taskName,taskDetails,taskStatus,dateOfExecution from task where taskStatus ="Accomplished" AND taskScheduler="Head Of Health Department" order by taskId desc');
