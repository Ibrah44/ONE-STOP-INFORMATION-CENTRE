...
echo	'</tr>';
	...
	$row=mysql_query('select taskId,taskName,taskDetails,taskStatus,dateOfExecution from task where taskScheduler="Head Of Health Department" order by taskId desc',$conn);
	...
	echo '</table>
			&nbsp;&nbsp;&nbsp;			
			<center><a href="scheduletask.php" class="btn btn-primary">Back</a> </center> 			
