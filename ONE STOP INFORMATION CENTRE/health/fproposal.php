           ...
           <nav class="navbar-default navbar-side" role="navigation">
                ...
                <ul class="nav" id="main-menu">
				    <li class="text-center">
                        ...
                        <li>
                        <a class=""  href="healthindex.php"><img src="pics/home.png" width="50" height="50px"> Home</a>
                    </li>
                        <li>
                ...
                <div class="row">
                    <div class="col-md-12">
                      <h2>Health Department</h2>
                        <h5>Please enter the details about the proposed project in the form below</h5>
                    </div>
                </div>
                 <!-- /. ROW  -->
                 <hr />
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-9">
                                    ...
                                    <form role="form" action="proposal.php" method="post" enctype="multipart/form-data">
                                        <div class="form-group input-group">
                                            <span class="input-group-addon"></span>';
											
	$row=mysql_query('SELECT projectId from project where submitedBy="Head Of Health Department" order by projectId desc LIMIT 1',$conn);
	
	
	while($shwduty = mysql_fetch_array($row))
	   {
				$id = $shwduty["projectId"];	
				$ans = 	++$id;				
											
                              echo '<input type="text" class="form-control" placeholder="'.$ans.'" name="ProjectId" value="'.$ans.'" readonly />
                                 </div>';
                                        ...
                                        <div class="form-group input-group">
                                            <span class="input-group-addon"></span>
                                 <input type="text" class="form-control" placeholder="Head Of Health Department"  name="SubmittedBy" value="Head Of Health Department" readonly/>
                                        </div>
                                        <div class="form-group input-group">
                                            <input type="date" class="form-control" name="DateOfSubmition"> <!-- date(d/m/y) -->
                                            <span class="input-group-addon">Date Of submition</span>
                                        </div>
                                           <div class="form-group input-group">
                                            <span class="input-group-addon"></span>
                                            <textarea rows="8" class="form-control" placeholder="Project Objective" name="purpose" required></textarea>
                                            
                                        </div>
                                             <div class="form-group input-group"><span class="input-group-addon">Attach Document</span>
                                            <input type="file" class="form-control" name="Doc"/>
                                             </div>
                                         <input type="submit" class="btn btn-primary" value="Send Proposal">&nbsp;&nbsp;&nbsp;
                                         <input class="btn btn-primary " type="reset" value="Refresh"></a> &nbsp;&nbsp;&nbsp;        
                                          <a href="proposalresponse.php" class="btn btn-primary ">View Authorisation Responce</a>
                                    </form>
