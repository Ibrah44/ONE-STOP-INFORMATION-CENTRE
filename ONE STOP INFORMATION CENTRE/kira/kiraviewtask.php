...
include ('connect.php');
//echo "<div class='no-print'>";kirataskperformance.php
echo "<table border='1' align='center' class='' width='950px'>";

echo "<tr/>
<td>
<a href='kirapendtasks.php'>View Pending Tasks</a>*****
<a href='kiraaccomptasks.php'>View Accomplished Tasks</a>
...
echo	'<tr id="no-print">
	...
	$gettask=mysql_query("select * from task  where taskScheduler like '%Kira%' ",$conn);
	
	
	while($shwtask = mysql_fetch_array($gettask))
	   {
	...
	echo '<center>';
    echo '<a href="kiratownsch.php "><input type="button" value="Previous" class="btn btn-primary " style=width:100px;></a>';
	echo '&nbsp;&nbsp;&nbsp';        
