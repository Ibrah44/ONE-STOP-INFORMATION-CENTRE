                    ...
                    <div class="col-md-12">
                     <h2>kira Town Council</h2>
                        <h5>Town Council Assets </h5>
						                           <form method="POST" action="kirasearchasset.php" class="no-print">
												   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
echo	'</tr>';
	$getasset=mysql_query("select * from asset where purchasedBy='Kira Town Clerk' ",$conn);
	...
	echo '<center class="no-print">';
    echo '<a href="kiratownassets.php "><input type="button" value="Previous Page" class="btn btn-primary " style="width:120px;"></a>';
	echo '&nbsp;&nbsp;&nbsp';        
