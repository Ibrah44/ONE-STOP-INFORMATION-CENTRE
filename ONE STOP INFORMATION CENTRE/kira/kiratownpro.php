                ...
                <div class="row">
                    <div class="col-md-12">
                      <h2>kira Town Council</h2>
                        <h5>Welcome To Projects Section</h5>
                    </div>
                </div>
                 <!-- /. ROW  -->
                 <hr />
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Please Provide Details For Proposed Project
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-9">
                                  
                                    <form role="form" method="post" action="kiratownproposal.php" enctype="multipart/form-data">
                                        <div class="form-group input-group">
                                            <span class="input-group-addon"></span>';
											
								$row=mysql_query('SELECT projectId from project where submitedBy="Kira Town Clerk" order by projectId desc LIMIT 1',$conn);
	...
	while($shwduty = mysql_fetch_array($row))
	   {
				...
				$ans = 	++$id;				
                                ...
                                echo          '  <input type="text" class="form-control" name="ProjectId" placeholder="Project Id" value="'.$ans.'"  readonly />
                                        </div>';
                                        ...
                                        <div class="form-group input-group">
                                            <input type="date" class="form-control" name="DateOfSubmission"> <!-- date(d/m/y) -->
                                            <span class="input-group-addon">Date Of submission</span>
                                        </div>
                                           <div class="form-group input-group">
                                            <span class="input-group-addon"></span>
                                            <textarea rows="5" class="form-control" placeholder="Project Objective" name="purpose" required></textarea>
                                            ...
                                            <input type="text" class="form-control"  value="kira Town Clerk" name="SubmittedBy" required/>
                                        </div>
                                        ...
                                        <input type="submit" value="Send Proposal" class="btn btn-primary "  style="width:160px;"/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                          ...
                                          <a href="kiratownproposalresponse.php" class="btn btn-primary " style="width:160px;">Submitted Proposals</a>
