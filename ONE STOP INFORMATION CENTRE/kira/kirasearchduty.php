...
//,assetName,purchaseDate,Amount
	...
	$sql="SELECT * from duty WHERE dutyName LIKE '%$result%'  or status LIKE '%$result%' or  dutyId LIKE '%$result%'  and assignedTo='Kira Town Clerk'";
...
while($shwinp= mysql_fetch_array($aresult))
	...
	{
	 echo"<h2>&nbsp;&nbsp;<font color='#000000'>Sorry no duty match found:</font> <font color='C44F00'>$result</h2>";
	 
	 echo '<br/>';
	 
	  echo '<a href="kiragetduties.php " style="padding:17px;"><input type="button" value="View All Duties" class="btn btn-primary " style="width:120px;"></a>';
	 
	 //echo "<a href='kiragetduties.php' style='width:120px; >View All Duty</a>";
	}
	mysql_close($conn);
