                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-9">
                                    ...
                                    <form role="form" method="post" action="kirasubmitrequest.php">
                                        <div class="form-group input-group">
                        						<span class="input-group-addon"></span>';
												
												
		$row=mysql_query('SELECT requestId from request where requestedBy="Kira Town Clerk" order by requestId desc LIMIT 1',$conn);
	...
	while($shwduty = mysql_fetch_array($row))
	   {
				...
				echo '							
                      <input type="text" class="form-control" placeholder="Requisation Id" name="RequisationId" value="'.$ans.'" readonly />
                                        </div>';
										}
                               ...
                               <input type="text" class="form-control" placeholder="Item Name" name="itemName" required />
                                        ...
                                        <div class="form-group input-group">
                                           ...
                                           <div class="form-group input-group">
                                            ...
                                            <input type="text" class="form-control" value="kirasana Town Clerk" name="Requestedby" required readonly/>
                                        </div>
                                        ...
                                        <div>
                                         ...
                                         &nbsp;&nbsp;
                                          ...
                                          <a href="kiraviewrequisation.php" class="btn btn-primary " style="width:135px;">View Requisations</a>
