...
$id = $_GET['id'];
$updatetask=mysql_query("select * from task where taskId='$id'");

while($getdatafromtask=mysql_fetch_array($updatetask))
...
$updatetaskdata=mysql_query("update task set taskStatus='$tstatus' where taskId='$tid' ");
