                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-9">
                                    ...
                                    <form role="form" action="kirasubmitsupervise.php" method="POST" enctype="multipart/form-data">
                                        <div class="form-group input-group">
                                            <span class="input-group-addon"></span>';
											
											
								$row=mysql_query('SELECT activityId from inspect where doneBy="Kira Town Clerk" order by activityId desc LIMIT 1',$conn);
	...
	while($shwduty = mysql_fetch_array($row))
	   {
				...
				$ans = 	++$id;	
                                 ...
                                 echo '           <input type="text" class="form-control" placeholder="Activity ID" name="activityId" value="'.$ans.'" readonly />
                                        </div>';
                                        ...
                                        <div class="form-group input-group">
                                            <span class="input-group-addon"></span>
                                        <input type="text" class="form-control" placeholder="Inspection ID " name="inspectionId" required/>
                                        </div>
                     ...
                     <input type="file" class="form-control" placeholder="Proof of Inspection" name="inspectionProof" >
                                ...
                                <input type="text" class="form-control" value="kira Town Clerk" name="insby" >
                                        ...
                                        <a href="kiraviewInspection.php " class="btn btn-primary " style="width:135px">Inspection Archive</a>
