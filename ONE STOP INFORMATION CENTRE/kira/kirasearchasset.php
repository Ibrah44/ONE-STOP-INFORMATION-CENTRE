...
//,assetName,purchaseDate,Amount
	...
	$sql="SELECT * from asset WHERE (purchasedBy) LIKE '%$result%'  or assetName LIKE '%$result%' or assetId LIKE '%$result%' or Amount LIKE '%$result%' and purchasedBy='Kira Town Clerk'";
