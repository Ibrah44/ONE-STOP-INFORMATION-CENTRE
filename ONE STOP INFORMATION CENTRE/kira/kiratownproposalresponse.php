                ...
                <div class="row">
                    <div class="col-md-12">
                     <h2>kira Town Council</h2>
                        <h5>Welcome';  echo' View Earlier Submitted Proposals. </h5>
                    </div>
                </div>              
                 <!-- /. ROW  -->
                  <hr />
...
echo	'</tr>';
	$row=mysql_query("select projectId, projectName,projectDetails,status,dateOfSubmission from project where submitedBy='kira Town Clerk'",$conn);
	...
	echo '</table>
			<br/>			
			<center><a href="kiratownpro.php" class="btn btn-primary" style="width:120px;">Back</a> </center> 			
