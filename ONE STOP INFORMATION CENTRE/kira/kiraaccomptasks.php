...
echo "<tr/>
<td width='300px'><a href='kirapendtasks.php'>View Pending Tasks</a>*****

<a href='kiraviewtask.php'>View All Tasks</a></td>
...
echo	'<tr>
	...
	$getpendingtask=mysql_query('select * from task where taskStatus="Accomplished" and taskScheduler="kira Town Clerk"    ',$conn);
	...
	echo '<center>';
    echo '<a href="kiratownsch.php "><input type="button" value="Back" class="btn btn-primary " style="width:135px;"></a>';
	echo '&nbsp;&nbsp;&nbsp';        
    echo '<a href="#" onClick="window.print();" return false; ><input type="button" value="Print" class="btn btn-primary " style="width:135px;"></a>';
		echo '<center/>';
