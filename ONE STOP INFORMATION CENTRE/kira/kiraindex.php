                ...
                <div class="row">
                 ...
                 <!-- /. ROW  -->
                  ...
                  ';
				  	 ...
				  	 echo '<div class="chat">';
				  //echo 'start chat';
				  			$qry1=mysql_query('select*from login where region="Kira"');			
while($shwduty1 = mysql_fetch_array($qry1))
	   {				
				echo '<a href="../kira/login.php?id='.$shwduty1["region"].'"><div  id="leave">Click to chat</div></a>';
...
$qry=mysql_query('select*from duty where assignedTo="Kira Town Clerk" ');			
...
//$qry = mysql_query("select duty.deadline, duty.dutyId, task.dateOfExecution, task.taskId from duty ,task  where duty.status=task.taskStatus ",$conn);	
$qry1=mysql_query('select*from task where taskScheduler="Head Of Fikirace Department"',$conn);			
while($shwduty1 = mysql_fetch_array($qry1))
	   {
