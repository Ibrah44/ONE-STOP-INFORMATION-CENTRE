            ...
            <div class="sidebar-collapse ">
				...
				<li class="text-center">
                    ...
                    <li>
						...
						<li>
                        <a  href="kiratownprop.php"><img src="pics/project.jpg" width="50" height="50px"></i> Propose Project</a>
                    </li>	
...
/* display assets of the town council*/
  ...
  //provide the graph image for kirasana,2014
  echo '<img src="kirad2014.php">';
echo '<center/>';	
