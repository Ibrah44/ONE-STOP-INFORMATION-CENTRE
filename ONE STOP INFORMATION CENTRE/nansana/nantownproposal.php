...
$passproject = mysqli_query($conn,"insert into project (projectId,projectName,projectDetails,status,dateOfSubmission,document,submitedBy)values

                                                   ('$pId','$pName',  '$pur',        '$status','$DOS',      '$docpath','$sBy')"
);

if($passproject)
header ('location:nantownpro.php');
