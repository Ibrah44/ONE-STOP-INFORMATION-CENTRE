                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-9">
                                    ...
                                    <form role="form" method="post" action="nantownproposal.php" enctype="multipart/form-data">
                                        <div class="form-group input-group">
                                            <span class="input-group-addon"></span>';
											
							
					$row=mysqli_query($conn,'SELECT projectId from project where submitedBy="Nansana Town Clerk" order by projectId desc LIMIT 1');
	...
	while($shwduty = mysqli_fetch_array($row))
	   {
				...
				$ans = 	++$id;				
                     ...
                     echo '      <input type="text" class="form-control"  name="ProjectId" value="'.$ans.'"  readonly />
                                        </div>';
                                        ...
                                        <div class="form-group input-group">
                                           ...
                                           <div class="form-group input-group">
                                            ...
                                            <input type="text" class="form-control"  value="Nansana Town Clerk" name="SubmittedBy" readonly/>
                                        </div>
                                        ...
                                        &nbsp;&nbsp;&nbsp;
                                          ...
                                          <a href="nantownproposalresponse.php" class="btn btn-primary " style="width:160px;">Submitted Proposals</a>
