...
echo "<tr/>
<td><a href='nanviewtask.php'>View All Tasks</a>*****

<a href='nanaccomptasks.php'>View Accomplished Tasks</a></td>
...
echo	'<tr>
	...
	//$getpendingtask=mysql_query("select * from task where taskStatus='Pending' and taskScheduler='Nansana Town Clerk'  ",$conn);
	$getpendingtask=mysqli_query($conn,"select * from task where taskStatus='Pending' and taskScheduler='Nansana Town Clerk'  ");
	
	
	while($shwtask = mysqli_fetch_array($getpendingtask))
	   {
	...
	echo '<center>';
    echo '<a href="nantownSchedule.php "><input type="button" value="Previous" class="btn btn-primary "></a>';
	echo '&nbsp;&nbsp;&nbsp';        
