...
$result=$_POST['search'];
	...
	$sql=mysql_query("SELECT * from inspect WHERE (inspectionId ) LIKE '%$result%'  or activityId LIKE '%$result%'  or activityName LIKE '%$result%'  && doneBy='Nansana Town Clerk'");
...
// create a page called viewTownAssets and include in the code
	...
	echo '<center>';
    echo '<a href="nanviewInspection.php "><input type="Back" value="Previous Page" class="btn btn-primary " style="width:120px;"></a>';
	echo '&nbsp;&nbsp;&nbsp';        
