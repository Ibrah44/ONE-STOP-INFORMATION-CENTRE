...
echo "<tr/>
<td width='300px'><a href='nanpendtasks.php'>View Pending Tasks</a>*****

<a href='nanviewtask.php'>View All Tasks</a></td>
...
echo	'<tr>
	...
	$getpendingtask=mysqli_query($conn,"select * from task where taskStatus='Accomplished'");
