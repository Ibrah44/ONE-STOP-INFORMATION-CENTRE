...
echo	'</tr>';
//where clause needed
	$getinspects=mysqli_query($conn,"select * from inspect where doneBy like '%Nansana%'  ");
...
echo	'</tr>';
	$getinspect = mysql_query("select activityId,inspectionId,activityName,inspectionDate from inspect where doneBy='Nansana Town Clerk' order by inspectionDate  ",$conn) 
	...
	*/
	...
	echo '<center>';
    echo '<a href="nantownsupervise.php "><input type="button" value="Previous Page" class="btn btn-primary " style="width:120px;"></a>';
	echo '&nbsp;&nbsp;&nbsp';        
