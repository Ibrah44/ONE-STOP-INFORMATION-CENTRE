           ...
           <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse ">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a href="nantownsupervise.php src="pics/inspection.jpg" width="50" height="50px"></i> Inspect Activities</a>
                    </li>
					...
					<li>
                        <a class=""  href="nantownSchedule.php"><img src="pics/schedule.png" width="50" height="50px"></i> Shedule</a>
                    </li>					
                </ul>
            </div>
        </nav>   <!-- /. NAV SIDE  -->
...
echo '<center/>';	
	...
	echo '<center>';
    echo '<a href="nananalysis.php "><input type="button" value="Back" class="btn btn-primary " style="width:110px;"></a>';
	echo '&nbsp;&nbsp;&nbsp';        
