...
//,assetName,purchaseDate,Amount
	...
	$sql="SELECT * from duty WHERE dutyName LIKE '%$result%'  or status LIKE '%$result%' or  dutyId LIKE '%$result%'  and assignedTo='Nansana Town Clerk'";
...
while($shwinp= mysql_fetch_array($aresult))
	...
	
	{
	 ...
	 echo '<br/>';
	  ...
	  echo '<a href="nangetduties.php "><input type="button" value="View All Duties" class="btn btn-primary " style="width:120px;"></a>';
	 
	 //echo "<a href='nangetduties.php' style='width:120px; >View All Duty</a>";
	}
	mysql_close($conn);
