...
echo	'</tr>';
	$row=mysqli_query($conn,"select requestId,itemName,quantity,requestDate,
	purpose,status,downloadApproval from request where requestedBy='Nansana Town Clerk'  order by requestDate");
	
	
	while($shwrequest = mysqli_fetch_array($row))
	   {
	...
	echo $shwrequest["downloadApproval"];
		...
		echo '	&nbsp;&nbsp;&nbsp;&nbsp;			
			<center><a href="nantownRequest.php" class="btn btn-primary" style="width:120px;">Back</a> </center> 			
