           ...
           <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse ">
              ...
              <li>
                    ...
                    <li>
                        <a  href="ftasset.php><img src="pics/asset.png" width="50" height="50px"> Assets Procured</a>
                        </li>
                </ul>
            </div>
        </nav>  
...
echo	'</tr>';
	$row=mysql_query('select projectId, projectName,projectDetails,status,dateOfSubmission from project where submitedBy= "Head Of Education Department"',$conn);
