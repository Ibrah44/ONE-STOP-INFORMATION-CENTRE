...
$row=mysql_query('SELECT assetId from asset where purchasedBy="Head Of Education Department" order by assetId desc LIMIT 1',$conn);
	...
	while($shwduty = mysql_fetch_array($row))
	   {
				...
				$ans = 	++$id;				
                              ...
                              echo '<input type="text" class="form-control" placeholder="'.$ans.'" name="AssetId" value="'.$ans.'" readonly  />
                                        ...
                                        <div class="form-group input-group">
                                            <span class="input-group-addon"></span>
                                            <input type="text" class="form-control" placeholder="Head Of Education Department" name="PurchasedBy" value="Head Of Education Department" readonly/>
                                        </div>
