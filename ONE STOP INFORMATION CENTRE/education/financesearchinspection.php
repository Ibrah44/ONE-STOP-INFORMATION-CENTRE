				...
				<li class="text-center">
                    ...
                    <li>
                        <a  href="frequisation.php"><img src="pics/requestnew.png" width="50" height="50px">Requistions</a>
							...
							<li>
                        <a  href="fproposal.phpl"><img src="pics/project.jpg" width="50" height="50px"> Propose Project</a>
                    </li>
                </ul>
            </div>
        </nav>   <!-- /. NAV SIDE  -->
...
//,assetName,purchaseDate,Amount
	...
	$sql="SELECT * from inspect WHERE (inspectionId) LIKE '%$result%'  or activityName LIKE '%$result%' AND doneBy='Head Of Education Department'";
