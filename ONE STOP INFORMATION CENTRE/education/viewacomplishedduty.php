...
echo	'</tr>';
	$row=mysql_query('select dutyId,dutyName,dutyDetails,status,deadline,doneDate from duty where status ="Acomplished" AND assignedTo="Head Of Education Department" order by dutyId desc');
