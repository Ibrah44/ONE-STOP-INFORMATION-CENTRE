            ...
            <div class="sidebar-collapse ">
				...
				<li class="text-center">
					...
					<a class=""><i class="fa  fa-3x"></i> <img src="pics/service.png" width="200" height="50px"></a>
                     ...
                     <li>
                        <a class=""  href="educationindex.php"><img src="pics/home.png" width="50" height="50px"></i> Home</a>
                    </li>
            ...
            <div id="page-inner">
                <div class="row">
                 ...
                 <!-- /. ROW  -->';
				 			 ...
				 			 echo '<table border="0" align="center" width="auto"> <tr> <td><a href="viewpendingtask.php">view pending tasks</a> &nbsp;&nbsp;&nbsp;&nbsp;</td>  <td><a href="viewacomplishedtask.php">view accomplished tasks</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>   <td><form method="POST" action="financesearchtask.php">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
...
echo	'</tr>';
	...
	$row=mysql_query('select taskId,taskName,taskDetails,taskStatus,dateOfExecution from task where taskScheduler="Head Of Education Department" order by taskId desc',$conn);
	...
	echo '</table>
			&nbsp;&nbsp;&nbsp;			
			<center><a href="stask.php" class="btn btn-primary">Back</a> </center> 			
