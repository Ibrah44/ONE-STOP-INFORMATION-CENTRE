...
echo	'</tr>';
	$row=mysql_query("select dutyId,dutyName,dutyDetails,status,deadline,doneDate from duty where assignedTo='Head Of Education Department' order by dutyId desc");
	...
	echo '</table>&nbsp;&nbsp;&nbsp;&nbsp;		 		
	<center><a href="educationindex.php" class="btn btn-primary">Back</a> </center>  			
