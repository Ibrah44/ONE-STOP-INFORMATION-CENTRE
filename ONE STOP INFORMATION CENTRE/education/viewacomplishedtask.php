...
<head>
    ...
    <title>View Accomplished Tasks</title>
	<!-- BOOTSTRAP STYLES-->
            ...
            <div id="page-inner">
                <div class="row">
                 ...
                 <!-- /. ROW  -->';
				 			 ...
				 			 echo '<table border="0" align="center" width="auto"> <tr> <td><a href="viewtask.php">view all available tasks</a> &nbsp;&nbsp;&nbsp;&nbsp;</td>  <td><a href="viewpendingtask.php">view pending tasks</a>&nbsp;&nbsp;&nbsp;&nbsp;</td>   </tr> </table>';	
                  echo '<hr />
                <div class="row">
...
echo	'</tr>';
	...
	$row=mysql_query('select taskId,taskName,taskDetails,taskStatus,dateOfExecution from task where taskStatus ="Acomplished" AND taskScheduler="Head Of Education Department" order by taskId desc');
