...
<head>
    ...
    <title>View Procured Assets</title>
	<!-- BOOTSTRAP STYLES-->
				...
				<li class="text-center">
                    <!--<img src="assets/img/find_user.png" class="user-image img-responsive"/>-->
					 <a class="" ><img src="pics/service.png" width="200" height="50px"></a>
                          ...
                          <li>
                        <a href="educationindex.php"> <img src="pics/home.png" width="50" height="50px"></i>Home</a>
                    </li>
                        <li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                 ...
                 <!-- /. ROW  --><br/>';
				 echo '<table border="0" align="center" width="950px"> <tr> <td><a href="assetprocuredpmonth.php">view assets procured in the previous month</a> &nbsp;&nbsp;&nbsp;&nbsp;</td>  <td><a href="assetprocuredpyear.php">view assets procured in the previous year</a></td> <td><form method="POST" action="financesearchasset.php">
												   &nbsp;&nbsp;&nbsp;&nbsp;
...
echo	'</tr>';
	$getasset=mysql_query("select * from asset where purchasedBy='Head Of Education Department' order by assetId desc",$conn);
	...
	echo '<center>';
    echo '<a href="fasset.php "><input type="button" value="Back" class="btn btn-primary "></a>';
	echo '&nbsp;&nbsp;&nbsp';     
	 echo '<a href="printasset.php"><input type="button" value="Print" class="btn btn-primary "></a>';   
