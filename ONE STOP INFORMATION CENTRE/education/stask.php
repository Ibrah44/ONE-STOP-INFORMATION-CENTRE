    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="educationindex.php">WISCO</a>
            </div>
                                ...
                                <div class="col-md-9">
                                    ...
                                    <form role="form" action="scheduletask.php" method="post">
                                        <div class="form-group input-group">
											...
											//SELECT LAST(taskId) FROM task where taskScheduler="Head Of Finance Department" order by taskId desc
											//SELECT taskId FROM task ORDER BY O_Id DESC LIMIT 1
											
	$row=mysql_query('SELECT taskId FROM task where taskScheduler="Head Of Education Department" order by taskId desc LIMIT 1',$conn);
	...
	while($shwduty = mysql_fetch_array($row))
	   {
				...
				$ans = 	++$id;				
                              ...
                              echo '<input type="text" class="form-control" placeholder="'.$ans.'" name="TaskId" value="'.$ans.'" readonly />
                                 </div>';
                                       ...
                                       echo ' <div class="form-group input-group">
                                        ...
                                        <div class="form-group input-group">
                                            <span class="input-group-addon"></span>
                         <input type="text" class="form-control" placeholder="Head Of Education Department" name="TaskSchuler"  value="Head Of Education Department" readonly/>
                                        </div>
                                        <div class="form-group input-group">
