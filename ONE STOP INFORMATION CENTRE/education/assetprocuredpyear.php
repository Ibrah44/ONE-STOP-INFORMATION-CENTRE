...
<head>
    ...
    <title>Annual Procured Assets</title>
	<!-- BOOTSTRAP STYLES-->
...
echo	'</tr>';
	$getasset=mysql_query("select * from asset WHERE purchaseDate like '%$di%' AND purchasedBy='Head Of Education Department' order by assetId desc",$conn);
	...
	echo '&nbsp;&nbsp;&nbsp';     
	 echo '<a href="printassety.php"><input type="button" value="Print" class="btn btn-primary "></a>';   
