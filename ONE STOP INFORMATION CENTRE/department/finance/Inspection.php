...
$sed =  mysql_query("insert into inspect(activityId,inspectionId,activityName,inspectionDate,inspectionProof,doneBy) values('$activityId','$inspectionId','$activityname','$date','$docpath','$inspectedby')");
