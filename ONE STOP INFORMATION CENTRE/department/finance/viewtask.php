...
echo	'</tr>';
	...
	$row=mysql_query('select taskId,taskName,taskDetails,taskStatus,dateOfExecution from task where taskScheduler="Head Of Finance Department" order by taskId desc',$conn);
