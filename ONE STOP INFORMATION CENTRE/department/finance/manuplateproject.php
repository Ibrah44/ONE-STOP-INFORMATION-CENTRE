           ...
           <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse ">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a class=""  href="index.php"><i class="fa fa-dashboard fa-3x"></i> Home</a>
                    </li>
                     <li>
                        <a  href=""><i class="fa fa-desktop fa-3x"></i> Assets</a>
                    </li>
                    
                    <li>
                        <a  href=""><i class="fa fa-desktop fa-3x"></i> Schedules</a>
                    </li>
                    ...
                    <li>
                        <a  href=" "><i class="fa fa-qrcode fa-3x"></i>Requistions</a>
                </ul>
            </div>
        </nav>  
        <!-- /. NAV SIDE  -->
