            ...
            <div class="sidebar-collapse ">
				...
				<li class="text-center">
					...
					<a class=""><i class="fa  fa-3x"></i> <img src="pics/service.png" width="200" height="50px"></a>
                      ...
                      <li>
                        <a class=""  href="departmentindex.php"><img src="pics/home.png" width="50" height="50px"></i> Home</a>
                    </li>
                    ...
                    <li>
                        <a  href="departmentasset.html"><img src="pics/asset.png" width="50" height="50px"> Asset Procurement</a>
					</li>
						<li>
                ...
                <div class="row">
                    <div class="col-md-12">
                     <h2>Finance Department</h2>
                        <h5>View records of the tasks assigned</h5>
...
//,assetName,purchaseDate,Amount
	...
	$sql="SELECT * from task WHERE (taskId) LIKE '%$result%'  or taskName LIKE '%$result%'AND taskScheduler='Head Of Finance Department'";
