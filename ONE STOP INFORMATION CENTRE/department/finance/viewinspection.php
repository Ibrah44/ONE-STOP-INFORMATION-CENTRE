 ...
 <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="departmentindex.html">WOSIC</a>
            </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                 ...
                 <!-- /. ROW  -->';
				 echo '<table border="0" align="center" width="auto"> <tr> <td><a href="inspectionpmonth.php">view inspections carried out in the previous month</a> &nbsp;&nbsp;&nbsp;&nbsp;</td>  <td><a href="inspectionpyear.php">view inspections carried out in the previous year</a>&nbsp;&nbsp;&nbsp;&nbsp;</td> <td><form method="POST" action="financesearchinspection.php">
												   &nbsp;&nbsp;&nbsp;&nbsp;
...
echo	'</tr>';
	$get=mysql_query("select * from inspect where doneBy='Head Of Finance Department' order by inspectionId desc",$conn);
	...
	echo '<center>';
    echo '<a href="finspection.php "><input type="button" value="Back" class="btn btn-primary "></a>';
	echo '&nbsp;&nbsp;&nbsp';     
