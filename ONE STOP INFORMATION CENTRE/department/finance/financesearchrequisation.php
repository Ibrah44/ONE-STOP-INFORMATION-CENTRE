<head>
    ...
    <title>Search Requisations</title>
	<!-- BOOTSTRAP STYLES-->
                ...
                <div class="row">
                    <div class="col-md-12">
                     <h2>Finance Department</h2>
                        <h5>View records of the requisations made</h5>
...
//,assetName,purchaseDate,Amount
	...
	$sql="SELECT * from request WHERE (requestId) LIKE '%$result%'  or itemName LIKE '%$result%' AND requestedBy='Head Of Finance Department'";
