...
<head>
    ...
    <title>View Proposed Projects</title>
	<!-- BOOTSTRAP STYLES-->
            ...
            <div class="sidebar-collapse ">
				...
				<li class="text-center">
					...
					<a class=""><i class="fa  fa-3x"></i> <img src="pics/service.png" width="200" height="50px"></a>
                        ...
                        <li>
                        <a href="finspection.html"> <img src="pics/inspection.jpg" width="50" height="50px"> Inspect Activities</a>
                    </li>
                     <li>
...
echo	'</tr>';
	$row=mysql_query('select projectId, projectName,projectDetails,status,dateOfSubmission from project where submitedBy= "Head Of Finance Department"',$conn);
	...
	echo '</table>
				&nbsp;&nbsp;&nbsp;&nbsp;	
			<center><a href="fproposal.php" class="btn btn-primary">Back</a> </center> 			
