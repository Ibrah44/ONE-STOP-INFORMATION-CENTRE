...
echo '
 <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header" id="no-print">
...
echo	'</tr>';
	$getprojects=mysqli_query($conn,'select * from project order by dateOfSubmission desc');
	
	
	while($shwprojects= mysqli_fetch_array($getprojects))
	   {
	...
	echo ' <tr>
	  ...
	  <td> <a href = '.$shwprojects["document"].' />Download</a></td>
	  ...
	  <td align="center"><a  href="caoeditproject.php?id='.$shwprojects["projectId"].'  ">Edit</a> </td>
...
echo '
 <div class="no-print" id="footer" style="background-color: #4D4D4D;">
      <div class="container">
