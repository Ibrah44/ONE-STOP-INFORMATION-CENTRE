           ...
           <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse ">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a class="index.php"  href="caoindex.php">Home</a>
                    </li>
                     <li>
                        <a  href="manupulateRequistion.php"><i class="fa fa-dashboard fa-3x"></i> Requisations</a>
                    </li>
                    
                    <li>
                        <a  href="viewDistrictAssets.php"><i class="fa fa-grcode fa-3x"></i>District Assets</a>
                    </li>
                    
					<li>
                        <a class=""  href="manipulateProject.php "><i class="fa fa-dashboard fa-3x"></i> Submitted Projects</a>
                    </li>
