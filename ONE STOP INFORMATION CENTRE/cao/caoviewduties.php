            ...
            <div id="page-inner">
                <div class="row">
                 ...
                 <!-- /. ROW  -->
				  ...
				  <td valign="bottom"><a href="caoanalysis.php "><input type="button" value="View Analysis" class="btn btn-primary " style="width:110px;"></a></td>
				<td align="right">
...
// create a page called view supervisions made and include in the code
...
echo	'</tr>';
	$getduties=mysqli_query($conn,'select dutyId,dutyName,dutyDetails,dateOfDutyAssignment,deadline,assignedTo,doneDate,status from duty order by doneDate desc');
	...
	echo '<center>';
    echo '<a href="caoallocateDuty.php "><input type="button" value="Back" class="btn btn-primary " style="width:110px;"></a>';
	echo '&nbsp;&nbsp;&nbsp';        
