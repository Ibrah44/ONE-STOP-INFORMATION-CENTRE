...
$graph = new PHPGraphLib(600,600);
 ...
 //Finance
             $dataf = mysql_query('SELECT * FROM duty where assignedTo="Head Of Finance Department"  && deadline like "2014%"  ');
                         $num_rof = mysql_num_rows($dataf);

                     //echo $num_ro."total"."<br/>";
					 
                     $resultf = mysql_query('SELECT * FROM duty where assignedTo="Head Of Finance Department" && status="Pending"  && deadline like "2014%" ');
		...
		$resultfi = mysql_query('SELECT * FROM duty where assignedTo="Head Of Finance Department" && status="Accomplished" && deadline like "2014%" ');
 ...
 //community
  $datac = mysql_query('SELECT * FROM duty where assignedTo="Head Of Finance Department"  && deadline like "2014%"  ');
                         $num_roc = mysql_num_rows($datac);

                     //echo $num_ro."total"."<br/>";
					 
                     $resultc = mysql_query('SELECT * FROM duty where assignedTo="Head Of Finance Department" && status="Pending"  && deadline like "2014%" ');
		...
		$resultfc = mysql_query('SELECT * FROM duty where assignedTo="Head Of Finance Department" && status="Accomplished" && deadline like "2014%" ');
 ...
 //health
  ...
  $datah = mysql_query('SELECT * FROM duty where assignedTo="Head Of Finance Department"  && deadline like "2014%"  ');
                         $num_roh = mysql_num_rows($datah);

                     //echo $num_ro."total"."<br/>";
					 
                     $resulth = mysql_query('SELECT * FROM duty where assignedTo="Head Of Finance Department" && status="Pending"  && deadline like "2014%" ');
		...
		$resultfh = mysql_query('SELECT * FROM duty where assignedTo="Head Of Finance Department" && status="Accomplished" && deadline like "2014%" ');
