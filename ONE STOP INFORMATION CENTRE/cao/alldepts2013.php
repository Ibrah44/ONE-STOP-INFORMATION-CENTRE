...
$graph = new PHPGraphLib(600,600);
 ...
 //community
  $datac = mysql_query('SELECT * FROM duty where assignedTo="Head Of Finance Department"  && deadline like "2013%"  ');
                         $num_roc = mysql_num_rows($datac);

                     //echo $num_ro."total"."<br/>";
					 
                     $resultc = mysql_query('SELECT * FROM duty where assignedTo="Head Of Finance Department" && status="Pending"  && deadline like "2013%" ');
		...
		$resultfc = mysql_query('SELECT * FROM duty where assignedTo="Head Of Finance Department" && status="Accomplished" && deadline like "2013%" ');
 ...
 //health
  ...
  $datah = mysql_query('SELECT * FROM duty where assignedTo="Head Of Finance Department"  && deadline like "2013%"  ');
                         $num_roh = mysql_num_rows($datah);

                     //echo $num_ro."total"."<br/>";
					 
                     $resulth = mysql_query('SELECT * FROM duty where assignedTo="Head Of Finance Department" && status="Pending"  && deadline like "2013%" ');
		...
		$resultfh = mysql_query('SELECT * FROM duty where assignedTo="Head Of Finance Department" && status="Accomplished" && deadline like "2013%" ');
 ...
 //education
  ...
  $datae = mysql_query('SELECT * FROM duty where assignedTo="Head Of Finance Department"  && deadline like "2013%"  ');
                         $num_roe = mysql_num_rows($datae);

                     //echo $num_ro."total"."<br/>";
					 
                     $resulte = mysql_query('SELECT * FROM duty where assignedTo="Head Of Finance Department" && status="Pending"  && deadline like "2013%" ');
		...
		$resultfe = mysql_query('SELECT * FROM duty where assignedTo="Head Of Finance Department" && status="Accomplished" && deadline like "2013%" ');
